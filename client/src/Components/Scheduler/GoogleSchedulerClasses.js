...
class GoogleSchedulerClasses extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            data: appointments,
        ...
        this.commitDeletedAppointment = this.commitDeletedAppointment.bind(
            this
        );
        ...
        this.onAddedAppointmentChange = this.onAddedAppointmentChange.bind(
            this
        );
